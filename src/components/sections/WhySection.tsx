        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {points.map((p, i) => (
              <div
                key={i}
                className="bg-white dark:bg-surface-dark p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-accent/10 hover:border-accent/30 transition-all group"
              >
