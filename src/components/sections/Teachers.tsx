  ...
  return (
    <section className="py-20 bg-background-light dark:bg-background-dark flex flex-col items-center justify-center px-4" id="teachers">
      <div className="w-full max-w-[1120px] min-h-[600px] relative rounded-[28px] overflow-hidden shadow-2xl isolate group bg-[#1a4332]">
        ...
        <div className="absolute inset-0 z-[-1] bg-gradient-to-t lg:bg-gradient-to-r from-black/80 via-black/40 to-transparent lg:from-transparent lg:via-[#1a4332]/60 lg:to-[#1a4332]"></div>
          ...
          <div className="w-full lg:w-[55%] flex-1 flex flex-col justify-between p-8 md:p-12 lg:p-16 text-left relative z-10 self-stretch">
            <div>
              <div className="mb-6 animate-fade-in-up">
                ...
                <p className="text-emerald-100 text-xl font-medium drop-shadow-md">원장 · 학습 설계 & 1:1 코칭</p>
              </div>
