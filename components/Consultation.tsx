                ...
                <div className="grid grid-cols-1 gap-7 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select 
                        className="block w-full rounded-xl border-slate-200 bg-slate-50/50 py-3.5 px-4 shadow-sm focus:border-primary focus:ring-primary dark:bg-slate-800 dark:border-slate-700 dark:text-white appearance-none transition-all" 
                        id="grade"
