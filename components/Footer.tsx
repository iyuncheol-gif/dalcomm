        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 mb-16">
          ...
          <div className="max-w-md">
            <div className="flex items-center gap-5 mb-6">
              <img 
                src="https://lh3.googleusercontent.com/d/1X-uV_xN-L6y4JpM-U0-W9_8p-x_S-Q6x" 
                alt="THE달콤플러스 로고" 
                className="h-20 w-auto object-contain"
              />
              <div className="flex flex-col">
                <span className="font-sans text-2xl font-black text-white leading-none">THE달콤플러스</span>
                <span className="text-xs font-bold text-accent tracking-[0.2em] mt-1.5 opacity-80 uppercase">Premium English Academy</span>
              </div>
            </div>
            <p className="text-base leading-relaxed mb-8 font-sans font-medium text-slate-300 word-keep-all">
              변화하는 입시 환경 속에서 흔들리지 않는 실력을 만듭니다.<br className="hidden md:block" />
            ...
            <div className="flex gap-4">
              {[
                ...
                <a key={i} className="flex h-10 w-10 items-center justify-center rounded-xl bg-surface-dark text-slate-400 transition hover:bg-accent hover:text-white" href="#">
          ...
          <div className="flex flex-col sm:flex-row gap-10 lg:gap-20">
            <div>
              <h4 className="mb-6 font-bold text-white text-base tracking-tight border-l-2 border-accent pl-3">상담 및 안내</h4>
              <ul className="space-y-4 text-[13px] font-medium">
                <li className="flex items-center gap-2.5">
                  <span className="material-symbols-outlined text-accent text-[18px]">call</span>
                  <span className="text-white text-xl font-bold">0507-1338-8444</span>
                </li>
            ...
            <div>
              <h4 className="mb-6 font-bold text-white text-base tracking-tight border-l-2 border-accent pl-3">고객 서비스</h4>
              <div className="flex flex-col gap-3.5 text-[13px] font-medium">
                {[
                  ...
                  <a key={i} className="flex items-center gap-1.5 hover:text-accent transition-colors w-fit text-slate-400" href={link.href}>
                    <span className="material-symbols-outlined text-accent text-[16px]">chevron_right</span> {link.text}
                  </a>
                ))}
              </div>
            </div>
